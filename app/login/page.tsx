      ...
      <div className="flex flex-col items-center gap-8 max-w-xs w-full">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-text-muted text-sm text-center">
            Your subscriptions, nothing else.
          </p>
        </div>
        ...
        >
          <button
            type="submit"
            className="flex items-center gap-3 px-5 py-3 bg-surface hover:bg-surface-elevated border border-border rounded-xl text-text-primary text-sm font-medium transition-colors"
          >
